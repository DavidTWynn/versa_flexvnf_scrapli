from versa_flexvnf_scrapli.flexvnf_sync_driver import default_sync_on_open, default_sync_on_close
from versa_flexvnf_scrapli.flexvnf_async_driver import default_async_on_open, default_async_on_close
...
FAILED_WHEN_CONTAINS = ["[error]","is currently not installed. You can install it by typing"]


class VersaFlexVNFDriver(NetworkDriver):
    def __init__(
        self,
        host: str,
        privilege_levels: Optional[Dict[str, PrivilegeLevel]] = None,
        default_desired_privilege_level: str = "cli",
        ...
        if privilege_levels is None:
            privilege_levels = deepcopy(DEFAULT_PRIVILEGE_LEVELS)
...
class AsyncVersaFlexVNFDriver(AsyncNetworkDriver):
    def __init__(
        self,
        host: str,
        privilege_levels: Optional[Dict[str, PrivilegeLevel]] = None,
